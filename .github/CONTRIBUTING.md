...
Generative AI and large language models (LLMs) can be helpful tools for contributors.  
Like any tool, they should be used with care and critical thinking when creating issues or pull requests.

If you use Generative AI or an LLM, please add a short note (disclaimer) in your issue or pull request to make this clear.  
For example, you can write:

> _This issue/pull request was assisted by AI._

### Acceptable Uses
* Help with writing comments, especially if English is not your first language  
* Understanding existing Wagtail code  
* Adding to your own knowledge for code, tests, or documentation  

### Unacceptable Uses
Maintainers may close issues and pull requests that are not useful or productive, including those that are fully generated by AI. 
